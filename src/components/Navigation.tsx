...
const Navigation = () => {
  ...
  return (
    ...
    >
      {/* Desktop Navigation */}
      <div className="hidden lg:flex items-center gap-1 px-5 py-3 rounded-full glass-panel shadow-soft border border-primary/10">
        <a href="#home" className="flex items-center px-2 hover:opacity-90 transition-opacity">
          <img 
            src={wellspringLogo} 
        ...
        <div className="h-12 w-px bg-gradient-to-b from-transparent via-primary/30 to-transparent mx-3" />
      ...
      <div className="lg:hidden">
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 rounded-full glass-panel shadow-soft border border-primary/10"
        >
          <img 
            src={wellspringLogo} 
            alt="Wellspring" 
            className="h-10 min-w-[100px] w-auto object-contain"
          />
          {isMobileMenuOpen ? (
